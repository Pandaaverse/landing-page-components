# Contributing to @pandaverse/landing-page-components
...
2. Clone your fork: `git clone https://github.com/pandaaverse/landing-page-components.git`
3. Navigate to the project directory: `cd landing-page-components`
...
If you have any questions, please [open an issue](https://github.com/pandaaverse/landing-page-components/issues/new) for discussion.

Thank you for contributing to @pandaverse/landing-page-components!
